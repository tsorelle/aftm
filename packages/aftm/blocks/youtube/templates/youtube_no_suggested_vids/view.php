...
/**
 * This template fixes a bug in the Youtube Video Block
 *
 * When "Show Related Videos" is unchecked, "rel=0" must be added to parameters.
 */
...
if (Page::getCurrentPage()->isEditMode()) {
    ...
    ?>>
		<div><?php echo t('YouTube Video disabled in edit mode.');
    ?></div>
	</div>
<?php
} else {
