...
echo '<div id="aftm-menu-launch" class="ccm-responsive-menu-launch visible-xs"><span style="color:#09f; font-style: italic">Menu </span><i></i></div>'; // empty i tag for attaching :after or :before psuedos for things like FontAwesome icons.
echo '<div id="aftm-mobile-menu"></div>';
