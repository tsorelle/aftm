...
module Tops {
    export class FinancialsViewModel implements IMainViewModel {
        static instance: Tops.FinancialsViewModel;
        ...
        constructor() {
            ...
            var me = this;
            Tops.FinancialsViewModel.instance = me;
...
Tops.FinancialsViewModel.instance = new Tops.FinancialsViewModel();
(<any>window).FinancialsViewModel = Tops.FinancialsViewModel.instance;
