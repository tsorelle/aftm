...
module Tops {
    export class MinutesViewModel implements IMainViewModel {
        static instance: Tops.MinutesViewModel;
        ...
        constructor() {
            ...
            var me = this;
            Tops.MinutesViewModel.instance = me;
...
Tops.MinutesViewModel.instance = new Tops.MinutesViewModel();
(<any>window).MinutesViewModel = Tops.MinutesViewModel.instance;
